 ...
 */
 ...
 /*
 * Modifications from SpanDSP g711.h:
 *  - SpanDSP-specific macros modified/removed
 *  - μ-law negative PCM handling adjusted (-1)
 */
...
static __inline__ uint8_t linear_to_ulaw(int linear)
{
    ...
    {
        /* Modification: added -1 for bit-exact behavior*/
        linear = G711_ULAW_BIAS - linear - 1;
        mask = 0x7F;
    }
